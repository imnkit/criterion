...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>">
			...
			<?php if ( !is_single() ) :
			if( get_the_post_thumbnail( $post_id, 'home-sub-img' ) == '') { ?> <img  src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/331-232.jpg" class="wp-post-image"> <?php } else {
...
<div class="sing-pg-menu">
 ...
 <div class="back-button" style="float:right;"><a href="javascript:" onclick="history.go(-1); return false" title="Back"> Back </a></div>
 <!--Post page Date text end-->
  <?php
 else :
			endif;
...
<a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>"><?php $tit = the_title('','',FALSE);

echo substr($tit, 0, 61);
$titletit= strlen($tit);if ($titletit > '61') { echo "..."; } else { }
?></a>
			</h1>
             <!--Post page Date text start-->
 <div class="dtr"><?php echo get_the_date('jS M Y');?></div>
 <!--Post page Date text end-->
		...
		<div class="entry-summary" style="clear: both;">
	<p><?php		$serchtext = get_the_excerpt(); echo $serchtext1 = substr($serchtext, 0,230); $lenth = strlen($serchtext); if ($lenth > '230') { echo "..."; } else { } ?> </p><a href="<?php the_permalink(); ?>" class="continue-reading" title="Continue Reading">Continue Reading</a> <?php //the_excerpt(); ?>
		</div><!-- .entry-summary -->
		<?php else : ?>
		<div class="entry-content" style="clear: both;margin-top: 150px;">
        <?php if ( is_single() ) : ?>
      ...
      <div class="video_box">
                                        <div class="case_study_video list">
                                            ...
                                            <a id="video" class="various fancybox.iframe" href="<?php echo $image_slider_video_src; ?>" ><img width="100%" height="100%" src="<?php echo get_template_directory_uri(); ?>/images/video-icon.png" ><br /> Check Video</a>
    ...
    <?php } ?>
      <!--Download section end-->
            ...
            <!--Index page post Content and redmore section start-->
              <p><?php  $intext = get_the_excerpt(); echo $intext1 = substr($intext, 0,230); $lenth = strlen($intext); if ($lenth > '230') { echo "..."; } else { }
?>
              </p><a href="<?php the_permalink(); ?>" class="continue-reading" title="Continue Reading">Continue Reading</a>
 ...
 <?php if ( is_single() ) : ?>
        ...
        <?php comments_template( '', true ); ?>
         ...
         <nav class="nav-single">
					...
					<span class="nav-previous" title="Previous Post"><?php next_post_link( '%link', '<span class="meta-nav">' . _x( '&larr;', '', 'twentytwelve' ) . '</span> ' ); ?></span>
					<span class="nav-next" title="Next Post"><?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '', '', 'twentytwelve' ) . '</span>' ); ?></span>
				</nav><!-- .nav-single -->
                <?php endif; ?>
