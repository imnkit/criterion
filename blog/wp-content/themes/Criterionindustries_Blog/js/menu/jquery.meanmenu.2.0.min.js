        ...
        return this.each(function () {
            ...
            function w() {
                if (currentWidth <= l) {
                    ...
                    jQuery(".mean-container").prepend('<div class="mean-bar"><p>menu</p><a href="#nav" class="meanmenu-reveal" style="' + meanStyles + '">Show Navigation</a><nav class="mean-nav"></nav></div>');
                    var t = jQuery(e).html();
