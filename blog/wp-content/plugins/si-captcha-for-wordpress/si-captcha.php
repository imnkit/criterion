...
$input_string = '<input id="captcha_code" name="captcha_code" placeholder="Verification Code *" type="text" value="" tabindex="4" '.$si_aria_required.' />';
...
$input_string = '<p class="comment-form-email"><input id="captcha_code" name="captcha_code" placeholder="Verification Code *" aria-required="true" type="text" size="6" /></p>
...
';
  ...
  $si_html .= '<img style="height:40px; width:250px;float:left;" id="'.$label.'" class="si-captcha" src="'.$securimage_show_url.'" '.$securimage_size.' alt="';
  ...
  $si_html .= '<div style="float:left; margin:5px 0 5px 40px" id="si_refresh_'.$form_id.'">'."\n";
  ...
  $si_html .= '      <img class="captchaImgRefresh" src="'.get_template_directory_uri().'/images/refresh.png" style="width:32px; height:32px;" alt="';
