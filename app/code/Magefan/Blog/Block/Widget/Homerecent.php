 ...
 */
class Homerecent extends \Magefan\Blog\Block\Post\PostList\AbstractList implements \Magento\Widget\Block\BlockInterface
{
    ...
    {
        $this->setTemplate(
            $this->getData('custom_template') ?: 'widget/home_recent.phtml'
        );
